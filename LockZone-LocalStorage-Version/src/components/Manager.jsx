            ...
            <div className="p-3 md:mycontainer min-h-[88.2vh]">
                ...
                <div className="flex flex-col p-4 text-black gap-7 items-center">
                    <input
                        ...
                        className="bg-white rounded-full border border-green-600 w-full p-4 py-1"
                        type="text"
                        name="site"
                        id="site"
                    />
                    ...
                    <button
                        ...
                        className="flex justify-center items-center gap-2 bg-green-500 hover:bg-green-300 cursor-pointer rounded-full px-8 py-1 w-fit border border-green-900"
                    >
                        <lord-icon
